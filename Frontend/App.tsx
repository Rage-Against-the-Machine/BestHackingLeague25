               ...
               <div className="absolute right-0 top-full mt-2 w-64 bg-paper border-2 border-ink shadow-paper p-4 z-50">
                  {userRole === 'GUEST' ? (
                    <div className="space-y-3">
                      <button onClick={() => handleViewChange('RANKING')} className="w-full text-left px-2 py-1 hover:bg-black/5 rounded flex items-center gap-2 font-serif border-b border-ink/10 pb-2"><Trophy size={16} /> Ranking Sklepów</button>
                      <button onClick={handleAuthNavigation} className="w-full text-left px-3 py-2 bg-white border border-ink hover:bg-highlight text-sm font-bold flex items-center gap-2"><User size={16} /> Logowanie / Rejestracja</button>
                    </div>
                  ) : (
                    <div className="space-y-2">
                      <button onClick={() => handleViewChange('BROWSE')} className="w-full text-left px-2 py-1 hover:bg-black/5 rounded flex items-center gap-2 font-serif"><ShoppingBag size={16} /> Gazetka</button>
                      <button onClick={() => handleViewChange('RANKING')} className="w-full text-left px-2 py-1 hover:bg-black/5 rounded flex items-center gap-2 font-serif"><Trophy size={16} /> Ranking Sklepów</button>
                      <button onClick={() => handleViewChange('MAP')} className="w-full text-left px-2 py-1 hover:bg-black/5 rounded flex items-center gap-2 font-serif"><MapIcon size={16} /> Mapa Okazji</button>
                      <button onClick={() => handleViewChange('PANEL')} className="w-full text-left px-2 py-1 hover:bg-black/5 rounded flex items-center gap-2 font-serif">{userRole === 'CLIENT' ? <User size={16} /> : <LayoutDashboard size={16} />} {userRole === 'CLIENT' ? 'Moje Konto' : 'Panel Sklepu'}</button>
